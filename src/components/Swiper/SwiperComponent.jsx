...
const SwiperComponent = () => {
    ...
    return (
        <div className='rounded-md overflow-hidden transition-all duration-1000'>
            {imgs.map((img, i) => i == slider && <div key={i} className='w-full h-[95vh] relative transition-[all] duration-500'>
                <img className='w-full h-full object-cover aspect-square bg-top transition-[all] duration-500' src={img.src} alt={img.src}/>
